        ...
        while (true) {
            try {
                ...
                if(intoPictureReceptionMode){
                    ...
                    //when the total number of bytes received will be >= to sizeOfTheImage we will know the transmission of the picture has ended
                    ...
                    if (totalNumberOfBytesReceived>=sizeOfTheImage){ // image transmission is finished
                        Log.d(TAG,"finished receiving picture");
